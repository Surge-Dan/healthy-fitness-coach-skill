...
const { createStyleToken, getColorOptions, getDesignModeOptions, overrideStyleToken, renderShareCardSvg } = require('../skills/healthy-fitness-coach/references/visuals.js');
